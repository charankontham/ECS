...
public class CartMapper {
    ...
    public static CartFinalDto mapToCartFinalDto(Cart cart, ProductServiceInterface productServiceInterface, CustomerServiceInterface customerServiceInterface) {
